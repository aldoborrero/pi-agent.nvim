...
describe('version', function()
  describe('string', function()
    it('should return the correct version string', function()
      ...
      assert.are.equal('0.1.0', result)
      assert.are.equal(string.format('%d.%d.%d', version.major, version.minor, version.patch), result)
    end)
  end)
  ...
  describe('print_version', function()
    it('should call vim.notify with correct message', function()
      ...
      assert.are.equal('Pi Agent version: ' .. version.string(), message_received)
