...
busted.it = function(name, fn)
  return old_it(name, function()
    ...
    if not success and not test_failed then
      ...
      print('  ✗ Error: ' .. result)
    elseif success and not test_failed then
...
local function run_tests()
  ...
  -- Use the actual test count tracked by the it() wrapper
  local test_count = _G.TEST_RESULTS.test_count
  local success_count = _G.TEST_RESULTS.successes
